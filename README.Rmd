...
`iptools` does not currently work easily on Windows; It _may_ be possible to get it working with a solid, separate build of Boost for Windows under cygwin and setting environment variables properly. The first person(s) to get this working under Windows gets a free copy of [Bob's book](http://dds.ec/amzn).
