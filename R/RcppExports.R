...
asn_init <- function(path) {
    invisible(.Call('iptools_asn_init', PACKAGE = 'iptools', path))
}

#' Test if the autonomous system database loaded
#'
#' @export
asn_db_is_loaded <- function() {
    .Call('iptools_asn_db_is_loaded', PACKAGE = 'iptools')
}

asn_lookup_ <- function(ips) {
    .Call('iptools_asn_lookup_', PACKAGE = 'iptools', ips)
}

asn_fin <- function() {
    invisible(.Call('iptools_asn_fin', PACKAGE = 'iptools'))
}
